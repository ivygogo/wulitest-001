  ...
  <div class="container">
    <div class="row mb-1 mt-5">
      <div class="col-md-7 text-left">
        <h2 class="section-title mb-3">房型瀏覽</h2>
      ...
      <div class="site-section" id="property-details">
          ...
          <div class="row">
            <div class="col-lg-7">
              <div class="owl-carousel slide-one-item with-dots">
                <div><img src="images/pp1.webp" alt="Image" class="img-fluid"></div>
                <div><img src="images/pp1.webp" alt="Image" class="img-fluid"></div>
                <div><img src="images/pp1.webp" alt="Image" class="img-fluid"></div>
              </div>
            </div>
            <div class="col-lg-5 pl-lg-5 ml-auto">
              <div class="mb-0">
                <h3 class="text-black mb-4 mt-4">單人房Ａ <a href="room01.jsp#contact-section" class="btn btn-primary" style="float: right;" >預約看房</a></h3>
                <p style="color:#37cfa2; font-size: 20px;"> 剩餘房數：6  </p>
                <p><span class="badge text-bg-primary me-3"> 租金 </span> <span  class=" mx-2">6000元/月 </span></p>
                <p><span class="badge text-bg-primary me-3"> 押金 </span> <span  class=" mx-2">２個月 </span></p>
                <p><span class="badge text-bg-primary me-3"> 房屋坐向 </span> <span  class=" mx-2">坐北朝南 </span></p>
                <p><span class="badge text-bg-primary me-3"> 內含傢俱 </span> <span  class=" mx-2">床、桌子、椅子、衣櫃 </span></p>
              <p><span class="badge text-bg-primary me-3"> 內含設備 </span> <span  class=" mx-2">冰箱、電視、冷氣、熱水器</span></p>
                <p><span class="badge text-bg-primary me-3"> 公共設施 </span> <span  class=" mx-2">垃圾場、洗衣房、停車場、電梯</span></p>
                <p><span  class=" mx-2">&nbsp;</span></p>
        ...
        <div class="row mx-2 mt-1">
            <div class="col-lg-7">
              ...
              <p><span class="badge text-bg-primary me-3"> 備註 </span> 
                <span  class=" mx-2">
                  <ul style="list-style-type: decimal;">
                    <li>不得養寵物</li>
                    <li>電費不含在租金內，需每月按時繳納</li>
                  </ul>
                  </span></p>
            </div>
...
<section class="site-section bg-light bg-image" id="contact-section" style="display:none;">
  <div class="container">
    <div class="row mb-5">
      <div class="col-12 text-center">
        <h2 class="section-title mb-3">預約看房</h2>
      </div>
    </div>
    <div class="row">
